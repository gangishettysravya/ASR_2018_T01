...
## Steps to run:To train the gmms:
	- run 'python3 train.py' in the terminal
	- the models are created in the ./model folder
	- To test the gmms : run 'python3 test.py' in the terminal 
	- The results obtained are in the ./results folder
	-Note : before training or testing is done train and test features should be computed and dumped into ./features folder and test.hdf
